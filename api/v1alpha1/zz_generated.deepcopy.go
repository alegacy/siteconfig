...
func (in *ClusterInstanceSpec) DeepCopyInto(out *ClusterInstanceSpec) {
	*out = *in
	...
	if in.HostNetworkAttachments != nil {
		in, out := &in.HostNetworkAttachments, &out.HostNetworkAttachments
		*out = make([]HostNetworkAttachmentTemplate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *HostNetworkAttachment) DeepCopyInto(out *HostNetworkAttachment) {
	*out = *in
	in.InterfaceRef.DeepCopyInto(&out.InterfaceRef)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HostNetworkAttachmentTemplate) DeepCopyInto(out *HostNetworkAttachmentTemplate) {
	*out = *in
	in.Spec.DeepCopyInto(&out.Spec)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HostNetworkAttachmentTemplate.
func (in *HostNetworkAttachmentTemplate) DeepCopy() *HostNetworkAttachmentTemplate {
	if in == nil {
		return nil
	}
	out := new(HostNetworkAttachmentTemplate)
	in.DeepCopyInto(out)
	return out
}
